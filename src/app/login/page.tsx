    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-neutral-50 dark:bg-neutral-950">
      <div className="w-full max-w-sm space-y-6 text-center">
        <div>
          ...
          <p className="mt-2 text-neutral-500 dark:text-neutral-400">Sign in to continue</p>
        </div>
        {error && (
        ...
        {hasGitHub && (
          ...
          >
            <button
              type="submit"
              className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-neutral-900 dark:bg-white px-4 py-2.5 text-sm font-medium text-white dark:text-neutral-900 hover:bg-neutral-800 dark:hover:bg-neutral-100 transition-colors"
            >
        ...
        {isDev && (
          ...
          >
            <input
              ...
              className="w-full rounded-lg border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 px-3 py-2 text-sm dark:text-white"
              placeholder="Email"
            />
            <button
              type="submit"
